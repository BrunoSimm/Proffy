...
async function pageStudy(req,res){
    const filters = req.query //Recebendo dados da URL pelo req.query

    if(!filters.subject || !filters.weekday || !filters.time){
        return res.render("study.html", { filters, subjects, weekdays }) // 1 parametro: rota da página, 2 parametro: infos que serão acessíveis pelo nunjucks
    }
